...
- parse_strace.pl - flagship product for the moment :)
  ...
  # strace -e trace=open,read,write -e write=275 -e read=275 -tt -v -ff -o strace.log -s 4096 -p 2029

  # (close your GPS app after some time and ctrl-c strace process)
